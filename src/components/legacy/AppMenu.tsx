...
import { findAllParent, findMenuItem, getAppMenuItems, getMenuItemFromURL, type MenuItemType } from '@/helpers/legacy/menu'
import { buyLink, supportLink } from '@/states/legacy'
