import { SelectFormInput, TextFormInput } from '@/components/legacy'
...
import { BsSliders, BsStarFill } from 'react-icons/bs'
import * as yup from 'yup'
import CourtViewModeToggle from './courtViewToggle'
...
const CourtListGridFilter = () => {
    const { isOpen, toggle } = useToggle()
    const priceRange = ['700', '1500']
...
export default CourtListGridFilter
