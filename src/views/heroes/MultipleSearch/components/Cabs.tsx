        ...
        <div className="tab-content" id="pills-tabContent3">
            ...
            <Row className="g-4">
              ...
              <Col md={6}>
                <div className="form-icon-input form-fs-lg">
                  <DatePicker className="form-control form-control-lg flatpickr" options={{ dateFormat: 'd M y' }} placeholder="Select pickup date" />
                  <span className="form-icon">
                    <div>
          ...
          >
            <Row className="g-4">
              ...
              <Col md={6} lg={3}>
                <div className="form-icon-input form-fs-lg">
                  <DatePicker className="form-control form-control-lg flatpickr" options={{ dateFormat: 'd M y' }} placeholder="Select return date" />
                  <span className="form-icon">
                    <div>
                      <BsCalendar className=" mb-1" size={21} />
                    </div>
