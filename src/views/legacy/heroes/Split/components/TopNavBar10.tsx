import { LogoBox, VerticalAppMenu } from '@/components/legacy'
import { getAppMenuItems } from '@/helpers/legacy/menu'
import { useScrollEvent, useToggle } from '@/hooks/legacy'
import { useAuthContext, useLayoutContext, type LayoutState } from '@/states/legacy'
