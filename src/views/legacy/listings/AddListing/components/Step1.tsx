import { CheckFormInput, DropzoneFormInput, FileFormInput, SelectFormInput, TextAreaFormInput, TextFormInput } from '@/components/legacy'
...
const Step1 = ({ stepperInstance, control }: StepProps) => {
  return (
    <div id="step-1" role="tabpanel" className="content fade show" aria-labelledby="steppertrigger1">
